...
export class Backend implements backendInterface {
    ...
    async getAllReservationsSortedByDateTime(): Promise<Array<Reservation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllReservationsSortedByDateTime();
    ...
    async getAllReservationsSortedByGuestName(): Promise<Array<Reservation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllReservationsSortedByGuestName();
                return from_candid_vec_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReservationById(arg0: bigint): Promise<Reservation> {
        if (this.processError) {
            try {
                const result = await this.actor.getReservationById(arg0);
                return from_candid_Reservation_n2(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async makeReservation(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string | null): Promise<bigint> {
        if (this.processError) {
            try {
...
function from_candid_Reservation_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Reservation): Reservation {
...
function from_candid_vec_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Reservation>): Array<Reservation> {
    return value.map((x)=>from_candid_Reservation_n2(_uploadFile, _downloadFile, x));
}
